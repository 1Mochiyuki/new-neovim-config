...
require('lazy').setup {
...

  {
    ...
    version = '*', -- Use '*' for the latest release
    config = function()
      -- Configure and enable the individual modules you want to use

      -- 1. Enable mini.splitjoin
      require('mini.splitjoin').setup {
        -- Optional configuration for splitjoin
      }
      require('mini.surround').setup()
      require('mini.ai').setup()

      -- 2. Enable mini.operators
      require('mini.operators').setup {
        -- Set the 'gS' mapping to use mini.splitjoin's toggle
        mappings = {
          splitjoin = 'gS',
        },
      }
      ...
      -- You can add other mini modules here, e.g., require('mini.surround').setup({})
    end,
  },
